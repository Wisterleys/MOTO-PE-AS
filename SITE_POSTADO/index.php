...
<body>
	...
	<header>
		...
		<nav>
			<p onmousemove="mudafoto(2)" onmouseout="mudafoto(1)"><a href="index.php">Home</a></p>
			<p onmousemove="mudafoto(3)" onmouseout="mudafoto(1)"><a href="pecas.php">Peças</a></p>
			<p onmousemove="mudafoto(5)" onmouseout="mudafoto(1)"><a href="cadastro.php">Cadastro</a></p>
			<p onmousemove="mudafoto(6)" onmouseout="mudafoto(1)"><a href="login.php">Login</p>
			<p onmousemove="mudafoto(7)" onmouseout="mudafoto(1)"><a href="quem.php">Quem somos</a></p>
		</nav>
		</div>
	</header>
	<section>
		<div id="ajeite">
			<img   class="foto" src="_slide/01.png">
			<img  class="foto" src="_slide/02.jpeg">
			<img  class="foto" src="_slide/03.jpg">
			<img  class="foto" src="_slide/04.jpg">
			<img  class="foto" src="_slide/05.jpg">
			<img  class="foto" src="_slide/06.jpg">
			<img  class="foto" src="_slide/07.jpg">
			<img  class="foto" src="_slide/08.jpg">
			<img  class="foto" src="_slide/09.jpg">
		</div>
	</section>
