...
<body>
	...
	<header id="tent">
		...
		<nav>
			<p onmousemove="mudafoto(2)" onmouseout="mudafoto(3)"><a href="index.php">Home</a></p>
			<p onmousemove="mudafoto(3)" onmouseout="mudafoto(3)"><a href="pecas.php">Peças</a></p>
			<p onmousemove="mudafoto(5)" onmouseout="mudafoto(3)"><a href="cadastro.php">Cadastro</a></p>
			<p onmousemove="mudafoto(6)" onmouseout="mudafoto(3)"><a href="login.php">Login</p>
			<p onmousemove="mudafoto(7)" onmouseout="mudafoto(3)"><a href="quem.php">Quem somos</a></p>
		</nav>
		</div>
	</header>
	<section id="fotos">
